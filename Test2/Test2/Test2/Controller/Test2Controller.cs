...
namespace Test2.Controller
{
    ...
    {
        public string pathDadosMoeda = Directory.GetCurrentDirectory() + @"..\..\..\Repository\DadosMoeda.csv";
        public string pathDadosCotacao = Directory.GetCurrentDirectory() + @"..\..\..\Repository\DadosCotacao.csv";
        public string pathDePara = Directory.GetCurrentDirectory() + @"..\..\..\Repository\De-Para.csv";
